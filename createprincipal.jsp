					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Name of Principal</label> <input type="text"
						...
						<div class="row" id="contacts">
							...
							<div class="col-sm-4 form-group">
								<label>Contact person name </label> <input type="text" id="contactname1" name="contactname1" placeholder="Enter contact person name here.."
									class="form-control">
							</div>
							<div class="col-sm-4 form-group">
								<label>Contact person designation </label> <input type="text" id="contactdesignation1" name="contactdesignation1" placeholder="Enter Contact person designation Here.."
									class="form-control">
