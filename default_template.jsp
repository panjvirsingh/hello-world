...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%=contextPath %>/scripts/tablegrid/gridcontrol.js"></script>
    ...
    <body>
     ...
     <div id="loadingImage" class="loading" style="display:none;">&nbsp;</div>
        <div class="lm_container" >
            <tiles:useAttribute name="selectedTab"/>
            <div class="lm_top header">
                <tiles:insertAttribute name="header">
                    <tiles:putAttribute name="selectedTab" value="${selectedTab}"/>
